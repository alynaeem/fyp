            ...
            for page_num in range(1, max_pages + 1):
                ...
                for index in range(cards.count()):
                    try:
                        ...
                        ref_html = None
                        if len(web_urls)>0:
                            ref_html = helper_method.extract_refhtml(web_urls[0], self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS, page)
                        ...
                        card_data = leak_model(
                            ...
                            m_content=entry_content.text_content(),
                            m_network=helper_method.get_network_type(self.base_url),
                            m_important_content=entry_content.text_content(),
                            m_weblink=web_urls,
