...
class _tezwsse5czllksjb7cwp65rvnk4oobmzti2znn42i43bjdfd2prqqkad(leak_extractor_interface, ABC):
    _instance = None
    ...
    def __new__(cls, callback=None):
        ...
        if cls._instance is None:
            cls._instance = super(_tezwsse5czllksjb7cwp65rvnk4oobmzti2znn42i43bjdfd2prqqkad, cls).__new__(cls)
    ...
    def seed_url(self) -> str:
        return "http://tezwsse5czllksjb7cwp65rvnk4oobmzti2znn42i43bjdfd2prqqkad.onion"
    ...
    def contact_page(self) -> str:
        return "TOX ID F8E24C7F5B12CD69C44C73F438F65E9BF560ADF35EBBDF92CF9A9B84079F8F04060FF98D098E "
    ...
    def parse_leak_data(self, page: Page):
        ...
        for card in cards:
            title = card.locator("div.card-title").inner_text().strip()

            description = card.locator("div.card-desc").inner_text().strip()

            logo_src = card.locator("img").get_attribute("src")
            ...
            card_data = leak_model(
                ...
                m_logo_or_images=[logo_src] if logo_src else [],
