...
class _pdcizqzjitsgfcgqeyhuee5u6uki6zy5slzioinlhx6xjnsw25irdgqd(leak_extractor_interface, ABC):
    ...
    def rule_config(self) -> RuleModel:
        return RuleModel(m_timeout=177200, m_fetch_proxy=FetchProxy.TOR, m_fetch_config=FetchConfig.PLAYRIGHT, m_threat_type= ThreatType.LEAK)
    ...
    def parse_leak_data(self, page: Page):
        try:
            cards = page.query_selector_all('.compact-table')
            error_count = 0
